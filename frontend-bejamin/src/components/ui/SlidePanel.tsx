...
export function SlidePanel({
  ...
  return createPortal(
    <>
      ...
      <div
        className={cn(
          "fixed inset-y-0 right-0 bg-royal-800 shadow-2xl z-[110] transition-transform duration-300 ease-in-out overflow-y-auto",
          widthClasses[width],
      ...
      >
        ...
        {/* Contenu */}
        <div className={cn("p-6 bg-royal-800", className)}>
          {children}
        </div>
      </div>
    </>,
