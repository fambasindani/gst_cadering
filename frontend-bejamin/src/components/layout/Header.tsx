...
export function Header({ onMenuToggle }: HeaderProps) {
  ...
  const pageTitle = useMemo(() => {
    ...
    const routeTitles: Record<string, string> = {
      ...
      '/stock/tracabilite': 'Traçabilité',
      '/stock/cuisson': 'Cuisson',
      '/stock/atelier': 'Atelier',
      '/stock/suivi-chlore': 'Suivi chlore',
      '/stock/controle-livraison': 'Contrôle livraison',
      ...
      '/validation/sortie-stock': 'Validation sorties',
      '/validation/retour-stock': 'Validation retours',
      ...
      '/configuration/parametres': 'Paramètres',
      ...
      '/rapports/variations-prix': 'Variations de prix',
      ...
      '/rapports/bon-livraison/:id': 'Détail bon de livraison',
      '/rapports/client': 'Rapport clients',
      '/rapports/client/:id': 'Détail client',
      '/rapports/sortie': 'Rapport sorties',
      '/rapports/sortie/:id': 'Détail sorties client',
      '/rapports/achat': 'Rapport achats',
      '/rapports/achat/:id': 'Détail achat',
      '/rapports/consommations': 'Consommations clients',
      '/rapports/consommations/:id': 'Détail consommation client',
      '/profil': 'Mon Profil',
      '/audit': 'Audit',
    };
    ...
    const dynamicPatterns: [RegExp, string][] = [
      ...
      [/^\/rapports\/bon-commande\/(\d+)$/, 'Détail bon de commande'],
      ...
      [/^\/stock\/tracabilite\/creer$/, 'Nouvelle traçabilité'],
      [/^\/stock\/tracabilite\/(\d+)\/modifier$/, 'Modifier traçabilité'],
      [/^\/stock\/tracabilite\/(\d+)$/, 'Détail traçabilité'],
      [/^\/stock\/cuisson\/creer$/, 'Nouvelle cuisson'],
      [/^\/stock\/cuisson\/(\d+)\/modifier$/, 'Modifier cuisson'],
      [/^\/stock\/cuisson\/(\d+)$/, 'Détail cuisson'],
      [/^\/stock\/atelier\/creer$/, 'Nouvel atelier'],
      [/^\/stock\/atelier\/(\d+)\/modifier$/, 'Modifier atelier'],
      [/^\/stock\/atelier\/(\d+)$/, 'Détail atelier'],
      [/^\/stock\/suivi-chlore\/creer$/, 'Nouveau suivi chlore'],
      [/^\/stock\/suivi-chlore\/(\d+)\/modifier$/, 'Modifier suivi chlore'],
      [/^\/stock\/suivi-chlore\/(\d+)$/, 'Détail suivi chlore'],
      [/^\/stock\/controle-livraison\/creer$/, 'Nouveau contrôle livraison'],
      [/^\/stock\/controle-livraison\/(\d+)\/modifier$/, 'Modifier contrôle livraison'],
      [/^\/stock\/controle-livraison\/(\d+)$/, 'Détail contrôle livraison'],
    ];
