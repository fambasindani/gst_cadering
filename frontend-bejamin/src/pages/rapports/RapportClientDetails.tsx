...
export function RapportClientDetails() {
  ...
  if (!mouvement) {
    return (
      <div className="text-center py-12">
        ...
        <Button variant="outline" className="mt-4" onClick={() => navigate('/rapports/client')}>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <Button variant="ghost" onClick={() => navigate('/rapports/client')} className="p-0 h-9 w-9 text-gray-500 hover:text-gray-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <Button variant="outline" className="w-full justify-start border-gray-200 text-gray-700 hover:bg-gray-50"
            onClick={() => navigate('/rapports/client')}>
