  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gray-100">
      <div className="w-full h-screen flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 h-full bg-royal-800 p-8 md:p-16 flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-xl bg-royal-500/30 flex items-center justify-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-lg bg-royal-500/20 flex items-center justify-center flex-shrink-0">
        ...
        <div className="w-full lg:w-1/2 h-full bg-[#F8F5F0] p-8 md:p-16 flex flex-col justify-center items-center">
          ...
          <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 md:p-10">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full h-12 bg-royal-700 hover:bg-royal-800 text-white font-medium rounded-lg transition-all duration-200 group text-base"
              >
                {isLoading ? (
                  <>
